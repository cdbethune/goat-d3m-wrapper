...
step_1 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.data_cleaning.geocoding.Goat_reverse'))
...
# Step 5: XG Boost clf
step_4 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.classification.xgboost_gbtree'))
